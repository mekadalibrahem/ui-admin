<aside id="default-sidebar"
    class="fixed top-10 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"
    aria-label="Sidenav">
    <div
        class="overflow-y-auto py-5 px-3 h-screen bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        <ul class="space-y-2">
            <li>
                <x-uiadmin.link :active="Route::currentRouteName() == 'admin.dashboard' ?? true" href="{{ route('admin.dashboard') }}" class="flex items-center p-2">
                    <svg aria-hidden="true" class="w-6 h-6  transition duration-75" fill="currentColor" viewBox="0 0 20 20"
            ...
            <li>
                <button type="button"
                    ...
                    <span class="flex-1 ml-3 text-left whitespace-nowrap">Authorization</span>
                    <svg aria-hidden="true" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
                            d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                ...
                <ul id="dropdown-authentication" class="hidden py-2 space-y-2">
                    <li>
                        <x-uiadmin.link :active="Route::currentRouteName() == 'admin.roles' ?? true" href="{{ route('admin.roles') }}" class="flex items-center">
                            Roles
                        </x-uiadmin.link>
                    ...
                    <li>
                        <x-uiadmin.link :active="Route::currentRouteName() == 'admin.permissions' ?? true" href="{{ route('admin.permissions') }}">
                            Permissions
                        </x-uiadmin.link>
                    ...
                    <li>
                        <x-uiadmin.link :active="Route::currentRouteName() == 'admin.users' ?? true"  href="{{ route('admin.users') }}">
                            User
                        </x-uiadmin.link>
